	...
	,main: function(args) {
		return tink_core__$Future_Future_$Impl_$._tryMap(this.testApi.test(args.param),function(result) {
			return new ufront_web_result_ViewResult(ufront_view__$TemplateData_TemplateData_$Impl_$.setObject((function($this) {
				...
				$r = obj != null?obj:{ };
				return $r;
			}(this)),{ title : "Ufront NodeJS Guide - Home", message : "Result: " + result, renderedBy : "Client"}));
		});
	}
	,execute: function() {
		...
		try {
			...
			throw new js__$Boot_HaxeError(ufront_web_HttpError.pageNotFound({ fileName : "HomeController.hx", lineNumber : 7, className : "controller.HomeController", methodName : "execute"}));
		} catch( e ) {
			haxe_CallStack.lastException = e;
			if (e instanceof js__$Boot_HaxeError) e = e.val;
			return ufront_core_SurpriseTools.asSurpriseError(e,"Uncaught error while executing " + Std.string(this.context.actionContext.controller) + "." + this.context.actionContext.action + "()",{ fileName : "HomeController.hx", lineNumber : 7, className : "controller.HomeController", methodName : "execute"});
		}
	}
...
controller_HomeController.__meta__ = { obj : { rtti : [["testApi","api.AsyncTestApi",""]]}, fields : { main : { wrapResult : [4]}}};
