...
controller_HomeController.prototype = $extend(ufront_web_Controller.prototype,{
	...
	,main: function() {
		...
		var tmp = new ufront_web_result_PartialViewResult(ufront_view__$TemplateData_TemplateData_$Impl_$.setObject(this1,{ title : "Confidant Communications : Graphic Design, Website Design and Joomla Interactive Developer in Saskatoon, Saskatchewan", panel1classes : "recessed0", panel2classes : "", panel3classes : ""}));
		var this2 = Type.getClassName(actions_ConfidantInterface);
		return ufront_web_result_AddClientActionResult.addClientAction(tmp,this2,{ msg : "simpleAction"});
	}
	...
	,portfolio: function() {
		...
		return tink_core__$Future_Future_$Impl_$._tryMap(this.testApi.getJson(path),function(result) {
			var d = { title : "Confidant Communications : Portfolio of Graphic Design and Website Development Projects", content : _gthis.processJson(result), portfolioItem : null, panel1classes : "recessed0 recessed1", panel2classes : "recessed0", panel3classes : "", gobackLink : "http://" + _gthis.getHostName() + "/"};
			var obj = { };
			var this1 = obj != null ? obj : { };
			var tmp = new ufront_web_result_PartialViewResult(ufront_view__$TemplateData_TemplateData_$Impl_$.setObject(this1,d));
			var this2 = Type.getClassName(actions_ConfidantInterface);
...
ufront_web_session_FileSession.prototype = {
	...
	,get: function(name) {
		if(!this.started) {
			throw new js__$Boot_HaxeError(ufront_web_HttpError.internalServerError("Trying to access session data before init() has been run",null,{ fileName : "FileSession.hx", lineNumber : 502, className : "ufront.web.session.FileSession", methodName : "checkStarted"}));
		}
		if(this.sessionData != null) {
			var _this = this.sessionData;
			if(__map_reserved[name] != null) {
