...
class ufront_app_DefaultUfrontController extends ufront_web_Controller {
	...
	public function execute() {
		...
		try {
			...
			throw new HException(ufront_web_HttpError::pageNotFound(_hx_anonymous(array("fileName" => "UfrontConfiguration.hx", "lineNumber" => 276, "className" => "ufront.app.DefaultUfrontController", "methodName" => "execute"))));
		}catch(Exception $__hx__e) {
			$_ex_ = ($__hx__e instanceof HException) ? $__hx__e->e : $__hx__e;
			$e = $_ex_;
			{
				return ufront_core_SurpriseTools::asSurpriseError($e, "Uncaught error while executing " . Std::string($this->context->actionContext->controller) . "." . _hx_string_or_null($this->context->actionContext->action) . "()", _hx_anonymous(array("fileName" => "UfrontConfiguration.hx", "lineNumber" => 276, "className" => "ufront.app.DefaultUfrontController", "methodName" => "execute")));
			}
		}
	}
