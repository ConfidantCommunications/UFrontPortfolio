...
class ufront_view__TemplateHelper_TemplateHelper_Impl_ {
	...
	static function getFn($this1) {
		...
		case 0:{
			$_e = $this1;
			return array(new _hx_lambda(array(&$_e), "ufront_view__TemplateHelper_TemplateHelper_Impl__0"), 'execute');
		}break;
		case 1:{
			$_e1 = $this1;
			return array(new _hx_lambda(array(&$_e1), "ufront_view__TemplateHelper_TemplateHelper_Impl__1"), 'execute');
		}break;
		case 2:{
			$_e2 = $this1;
			return array(new _hx_lambda(array(&$_e2), "ufront_view__TemplateHelper_TemplateHelper_Impl__2"), 'execute');
		}break;
		case 3:{
			$_e3 = $this1;
			return array(new _hx_lambda(array(&$_e3), "ufront_view__TemplateHelper_TemplateHelper_Impl__3"), 'execute');
		}break;
		case 4:{
			$_e4 = $this1;
			return array(new _hx_lambda(array(&$_e4), "ufront_view__TemplateHelper_TemplateHelper_Impl__4"), 'execute');
		}break;
		case 5:{
			$_e5 = $this1;
			return array(new _hx_lambda(array(&$_e5), "ufront_view__TemplateHelper_TemplateHelper_Impl__5"), 'execute');
		}break;
		case 6:{
			$_e6 = $this1;
			return array(new _hx_lambda(array(&$_e6), "ufront_view__TemplateHelper_TemplateHelper_Impl__6"), 'execute');
		}break;
		case 7:{
			$_e7 = $this1;
			return array(new _hx_lambda(array(&$_e7), "ufront_view__TemplateHelper_TemplateHelper_Impl__7"), 'execute');
		}break;
		default:{
			throw new HException("TemplateHelpers can have a maximum of 7 arguments");
		}break;
