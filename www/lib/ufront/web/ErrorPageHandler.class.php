...
class ufront_web_ErrorPageHandler implements ufront_app_UFErrorHandler{
	...
	public function handleError($httpError, $ctx) {
		...
		$ctx->messages->push(_hx_anonymous(array("msg" => "Handling error: " . Std::string($httpError) . _hx_string_or_null($inner) . _hx_string_or_null($callStack), "pos" => _hx_anonymous(array("fileName" => "ErrorPageHandler.hx", "lineNumber" => 44, "className" => "ufront.web.ErrorPageHandler", "methodName" => "handleError")), "type" => ufront_log_MessageType::$MError)));
