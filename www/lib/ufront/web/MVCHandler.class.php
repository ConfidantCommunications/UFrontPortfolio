...
class ufront_web_MVCHandler implements ufront_app_UFRequestHandler{
	...
	public function handleRequest($ctx) {
		$_gthis = $this;
		return tink_core__Future_Future_Impl_::_tryFailingFlatMap($this->processRequest($ctx), array(new _hx_lambda(array(&$_gthis, &$ctx), "ufront_web_MVCHandler_0"), 'execute'));
	}
