...
class ufront_web_context_RequestCompletion extends Enum {
	...
	public static $CErrorHandlersTriggered;
	...
	public static $__constructors = array(6 => 'CErrorHandlersComplete', 5 => 'CErrorHandlersTriggered', 4 => 'CFlushComplete', 3 => 'CLogHandlersComplete', 1 => 'CRequestHandlersComplete', 0 => 'CRequestMiddlewareComplete', 2 => 'CResponseMiddlewareComplete');
	}
ufront_web_context_RequestCompletion::$CErrorHandlersComplete = new ufront_web_context_RequestCompletion("CErrorHandlersComplete", 6);
ufront_web_context_RequestCompletion::$CErrorHandlersTriggered = new ufront_web_context_RequestCompletion("CErrorHandlersTriggered", 5);
