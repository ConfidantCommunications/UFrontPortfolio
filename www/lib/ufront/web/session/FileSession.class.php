...
class ufront_web_session_FileSession implements ufront_web_session_UFHttpSession{
	...
	public function doSaveSessionContent($_) {
		...
		if($tmp) {
			...
			return ufront_core_SurpriseTools::tryCatchSurprise(array(new _hx_lambda(array(&$content, &$filePath), "ufront_web_session_FileSession_3"), 'execute'), null, _hx_anonymous(array("fileName" => "FileSession.hx", "lineNumber" => 351, "className" => "ufront.web.session.FileSession", "methodName" => "doSaveSessionContent")));
		} else {
			return ufront_core_SurpriseTools::success();
		}
	}
	...
	public function doCloseSession($_) {
		if($this->closeFlag) {
			$this->setCookie("", -1);
			$filename = "" . _hx_string_or_null($this->savePath) . _hx_string_or_null($this->sessionID) . ".sess";
			return ufront_core_SurpriseTools::tryCatchSurprise(array(new _hx_lambda(array(&$filename), "ufront_web_session_FileSession_4"), 'execute'), null, _hx_anonymous(array("fileName" => "FileSession.hx", "lineNumber" => 376, "className" => "ufront.web.session.FileSession", "methodName" => "doCloseSession")));
		} else {
			return ufront_core_SurpriseTools::success();
		}
	}
