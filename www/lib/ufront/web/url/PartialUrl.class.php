...
class ufront_web_url_PartialUrl {
	...
	public function toString() {
		...
		$qs = $this->queryString();
		if(strlen($qs) > 0) {
			$url = _hx_string_or_null($url) . _hx_string_or_null(("?" . _hx_string_or_null($qs)));
		}
		if(null !== $this->fragment) {
			$url = _hx_string_or_null($url) . _hx_string_or_null(("#" . _hx_string_or_null($this->fragment)));
		}
		return $url;
	}
